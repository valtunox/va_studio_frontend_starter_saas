/**
 * VA Studio Frontend — SaaS Landing Standalone
 *
 * This is a standalone version of the SaaS Landing template.
 * It renders the SaaS Landing template directly as the main interface.
 *
 * Routes:
 *   /  → SaaS Landing template (default)
 *
...
import TemplateApp from '../templates/saas/App.jsx'
...
/* ------------------------------------------------------------------ */
/*  Home Page (SaaS Landing Template with Connectivity Banner)       */
/* ------------------------------------------------------------------ */
